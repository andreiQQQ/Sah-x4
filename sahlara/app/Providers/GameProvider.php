...
class GameProvider
{
    public function initGameTable(GameSession $session)
    {
        ...
        $gameTable = [
            ...
            // 4
            new Piece($subscriptions[0], Piece::ROOK, [11, 2]),
            new Piece($subscriptions[0], Piece::KNIGHT, [11, 3]),
            new Piece($subscriptions[0], Piece::BISHOP, [11, 4]),
            new Piece($subscriptions[0], Piece::QUEEN, [11, 5]),
            new Piece($subscriptions[0], Piece::KING, [11, 6]),
            new Piece($subscriptions[0], Piece::BISHOP, [11, 7]),
            new Piece($subscriptions[0], Piece::KNIGHT, [11, 8]),
            new Piece($subscriptions[0], Piece::ROOK, [11, 9]),

            new Piece($subscriptions[0], Piece::PAWN, [10, 2]),
            new Piece($subscriptions[0], Piece::PAWN, [10, 3]),
            new Piece($subscriptions[0], Piece::PAWN, [10, 4]),
            new Piece($subscriptions[0], Piece::PAWN, [10, 5]),
            new Piece($subscriptions[0], Piece::PAWN, [10, 6]),
            new Piece($subscriptions[0], Piece::PAWN, [10, 7]),
            new Piece($subscriptions[0], Piece::PAWN, [10, 8]),
            new Piece($subscriptions[0], Piece::PAWN, [10, 9]),
        ];
